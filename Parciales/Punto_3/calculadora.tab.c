...
static double newton_sqrt(double x) {
    if (x < 0.0) {
        fprintf(stderr, "Error: sqrt no definida para negativos, y NO QUIERO HACER IMAGINARIOS, GRACIAS (%.10g)\n", x);
        return NAN;
    }
    if (x == 0.0) {
        return 0.0;
...
{
     -10,    12,   -10,   -10,    -9,   -10,    17,    17,   -10,    38,
      17,   -10,    23,   -10,    17,    17,    17,    17,    30,   -10,
      -3,    -3,   -10,   -10,   -10
};
...
{
       2,     0,     1,    13,     0,     4,     0,     0,     3,     0,
       0,    10,     0,     5,     0,     0,     0,     0,     0,    11,
       6,     7,     8,     9,    12
};
...
{
      11,    12,    10,     0,    18,    16,    17,     0,    20,    21,
      22,    23,     2,     0,     0,     3,     4,     5,     0,     6,
       3,     4,     0,     7,     6,     0,     0,     0,     7,    14,
      15,    16,    17,     0,     0,    19,    14,    15,    16,    17,
       0,     0,    24,    13,    14,    15,    16,    17
};

static const yytype_int8 yycheck[] =
{
       6,     7,    11,    -1,    10,     8,     9,    -1,    14,    15,
...
#line 72 "calculadora.y"
                         { (yyval.num) = newton_sqrt((yyvsp[-1].num)); }
